...
- Updated installation, trajectory-mode, regression-suite, help-system, and repository documentation.
- Updated the public repository URL to:
  ```text
