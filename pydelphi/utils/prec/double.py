...
@jit(["bool_(float64[:])"], nopython=True, cache=True)
...
def dist_square(a, b):
    ...
    Returns:
        float64: The square of the distance between point 'a' and point 'b'.
    """
...
def distance(a, b):
    ...
    Returns:
        float64: The distance between point 'a' and point 'b'.
    """
...
def get_atom_field(atom_data, field_id):
    ...
    Returns:
        float64: The value of the specified atom field.
    """
    return atom_data[field_id]


@jit(["void(float64[:], float64, int64)"], nopython=True, cache=True)
def set_atom_field(atom_data, value, field_id):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        value (float64): The value to set for the specified field.
...
def atom_media_id(atom_data):
    ...
    Returns:
        float64: The media-id  of the atom.
    """
    return atom_data[ATOMFIELD_MEDIA_ID]


@jit(["void(float64[:], float64[:], float64)"], nopython=True, cache=True)
def set_atom_grid_coords(atom_data, grid_origin, h):
    ...
    Args:
        ...
        h (float64): The grid spacing, i.e., the real-space distance between adjacent grid lines.
    """
...
def to_grid_coords(crd3d_nparray, grid_origin, h):
    ...
    """
    crd3d_grid_crd3d = np.array([0, 0, 0], dtype=np.float64)
...
def set_atom_charge(atom_data, charge):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        charge (float64): The charge value to set for the atom.
    """
...
def set_atom_radius(atom_data, radius):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        radius (float64): The radius value to set for the atom.
    """
...
def set_atom_gaussiansigma(atom_data, gaussiansigma):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        gaussiansigma (float64): The Gaussian sigma value to set for the atom.
    """
...
def get_atom_charge(atom_data):
    ...
    Returns:
        float64: The charge of the atom.
    """
...
def get_atom_radius(atom_data):
    ...
    Returns:
        float64: The radius of the atom.
    """
...
def get_atom_gaussiansigma(atom_data):
    ...
    Returns:
        float64: The Gaussian sigma value of the atom.
    """
...
def get_atom_grid_x(atom_data):
    ...
    Returns:
        float64: The grid x-coordinate of the atom.
    """
...
def get_atom_grid_y(atom_data):
    ...
    Returns:
        float64: The grid y-coordinate of the atom.
    """
...
def get_atom_grid_z(atom_data):
    ...
    Returns:
        float64: The grid z-coordinate of the atom.
    """
...
def get_atom_reskey(atom_data):
    ...
    Returns:
        float64: The residue key of the atom.
    """
...
def get_atom_lj_sigma(atom_data):
    ...
    Returns:
        float64: The Lennard-Jones sigma value of the atom.
    """
...
def get_atom_lj_epsilon(atom_data):
    ...
    Returns:
        float64: The Lennard-Jones epsilon value of the atom.
    """
...
def get_atom_vdw_gamma(atom_data):
    ...
    Returns:
        float64: The van der Waals gamma value of the atom.
    """
...
def set_atom_reskey(atom_data, value):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        value (float64): The residue key value to set for the atom.
    """
...
def set_atom_lj_sigma(atom_data, value):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        value (float64): The Lennard-Jones sigma value to set.
    """
...
def set_atom_lj_epsilon(atom_data, value):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        value (float64): The Lennard-Jones epsilon value to set.
    """
...
def set_atom_vdw_gamma(atom_data, value):
    ...
    Args:
        atom_data (np.ndarray): A NumPy array containing atom properties.
        value (float64): The van der Waals gamma value to set.
    """
...
def crd3d_len(crd3d_nparr):
    ...
    Returns:
        float64: The length of the 3D vector.
    """
    d_sum = 0.0
...
def crd3d_scalar_sub(crd3d_nparr, v):
    ...
    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D vector.
        v (float64 or int64): The scalar value to subtract.
...
def crd3d_int_scalar_sub(crd3d_nparr, v):
    ...
    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D integer vector.
        v (int64): The scalar integer value to subtract.
...
def crd3d_scalar_mult(crd3d_nparr, v):
    ...
    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D vector.
        v (float64 or int64): The scalar value to multiply by.
...
def crd3d_sum(crd3d_nparr):
    ...
    Returns:
        float64: The sum of the x, y, and z components of the vector.
    """
...
def crd3d_scalar_div(crd3d_nparr, v):
    ...
    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D vector.
        v (float64 or int64): The scalar value to divide by.
...
def or_ge_scalar(crd3d_nparr, value):
    ...
    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D vector.
        value (float64 or int64): The scalar value to compare against.
...
def or_le_scalar(crd3d_nparr, value):
    ...
    """
    result = (
        crd3d_nparr[0] <= value or crd3d_nparr[1] <= value or crd3d_nparr[2] <= value
    )
    return result
...
def or_lt_scalar(crd3d_nparr, value):
    ...
    """
    result = crd3d_nparr[0] < value or crd3d_nparr[1] < value or crd3d_nparr[2] < value
    return result
...
def and_lt_scalar(crd3d_nparr, value):
    ...
    """
    result = (
        crd3d_nparr[0] < value and crd3d_nparr[1] < value and crd3d_nparr[2] < value
    )
    return result
...
def and_lt_vector(crd3d_nparr, value):
    ...
    result = (
        crd3d_nparr[0] < value[0]
        and crd3d_nparr[1] < value[1]
        and crd3d_nparr[2] < value[2]
    )
    return result
...
def or_gt_vector(crd3d_nparr, crd3d_nparr2):
    """
    Check if any component of a 3D vector is greater than the corresponding component of another 3D vector.
    ...
    """
    result = (
        crd3d_nparr[0] > crd3d_nparr2[0]
        or crd3d_nparr[1] > crd3d_nparr2[1]
        or crd3d_nparr[2] > crd3d_nparr2[2]
    )
    return result
...
def or_gt_vector_ref(crd3d_nparr, crd3d_ref):
    ...
    """
    result = (
        crd3d_nparr[0] > crd3d_ref[0]
        or crd3d_nparr[1] > crd3d_ref[1]
        or crd3d_nparr[2] > crd3d_ref[2]
    )
    return result
...
def and_gt_vector(crd3d_nparr, crd3d_ref):
    ...
    result = (
        crd3d_nparr[0] > crd3d_ref[0]
        and crd3d_nparr[1] > crd3d_ref[1]
        and crd3d_nparr[2] > crd3d_ref[2]
    )
    return result
...
def minimum_component(crd3d_nparr):
    ...
    Returns:
        float64 or int64: The minimum value among the x, y, and z components.
    """
...
def component_min_scalar(crd3d_nparr, value):
    ...
    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D integer vector.
        value (int64): The scalar integer value to compare with each component.
...
def maximum_component(crd3d_nparr):
    ...
    Returns:
        float64 or int64: The maximum value among the x, y, and z components.
    """
...
def crd3d_to_float(crd3d_nparr):
    """
    Convert a 3D vector array to float64 type.

    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D vector.

    Returns:
        np.ndarray: A NumPy array of shape (3,) representing the same vector, but with float64 data type.
    """
    c = crd3d_nparr.astype(np.float64)
    return c
...
def crd3d_to_int(crd3d_nparr):
    """
    Convert a 3D vector array to int64 type.

    Args:
        crd3d_nparr (np.ndarray): A NumPy array of shape (3,) representing a 3D vector.

    Returns:
        np.ndarray: A NumPy array of shape (3,) representing the same vector, but with int64 data type.
    """
    c = crd3d_nparr.astype(np.int64)
    return c
...
def crd3d_grid_distance_factor(crd3d_grid_coords, neighbor_grid_index, neighbor_offset):
    ...
    Args:
        crd3d_grid_coords (float64[:]): The 3D coordinates of a point within the grid.
        neighbor_grid_index (float64[:] or int64[:]): The 3D integer indices of a neighboring grid point.
        neighbor_offset (float64[:] or int64[:]): The 3D offset of the neighbor relative to the
            floor of its grid cell.  Represents one vertex of the unit cube.

    Returns:
        float64: The calculated distance factor used in trilinear interpolation.
    """
    d_diff = 1.0
    for i in range(3):
        d_diff *= (
...
def crd3d_grid_neighbors(crd3d_grid_coords):
    ...
    Args:
        crd3d_grid_coords (float64[:] or int64[:]): The 3D coordinates of a point within the grid.

    Returns:
        float64[:,:]: A NumPy array of shape (8, 4). Each row represents a neighbor:
                      - Columns 0-2: Integer grid indices (x, y, z).
                      - Column 3: The distance factor for trilinear interpolation.
    """
    floor_coords = crd3d_to_int(crd3d_floor(crd3d_grid_coords))
